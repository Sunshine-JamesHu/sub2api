...
func (h *OpenAIGatewayHandler) Images(c *gin.Context) {
	...
	if decision := h.checkSecurityAuditWithSessionBody(c, reqLog, apiKey, subject, service.ContentModerationProtocolOpenAIImages, requestModel, parsed.ModerationBody(), body); decision != nil && !decision.AllowNextStage {
