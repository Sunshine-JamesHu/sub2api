export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      blockedKeywordsPlaceholder: 'One blocking rule per line, e.g.:\nbadword1\nhaha A CCB',
      blockedKeywordsDescription: 'Matching is case-insensitive. Multiple whitespace-separated terms on the same line must all be present; any matching line blocks. Whether the upstream moderation API is invoked after a hit depends on the strategy below.',
      ...
      blockedKeywordsLimit: 'Up to {max} rules, each no longer than 200 characters. Duplicates are removed automatically.',
